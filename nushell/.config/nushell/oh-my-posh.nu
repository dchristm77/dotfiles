...
$env.POSH_THEME = (echo "/Users/derekchristman/.config/ohmyposh/zen.toml")
$env.PROMPT_INDICATOR = ""
$env.POSH_SESSION_ID = (echo "3d098f61-4683-4782-9f9e-05468b21c586")
$env.POSH_SHELL_VERSION = (version | get version)

let _omp_executable: string = (echo "/usr/local/bin/oh-my-posh")
